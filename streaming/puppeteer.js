...
(async () => {
    ...
    const venc = `venc=x264{profile=main,preset=ultrafast,tune=zerolatency,vbv-maxrate=${VIDEO_BITRATE},vbv-bufsize=8000,keyint=12,bframes=5,hrd=cbr,x264-scenecut=-1}`
    ...
    const outputOpts = `access=rtmp,mux=ffmpeg{mux=flv},dst=${RTMP_SERVER_URL}/${STREAM_KEY}`
    const cvlcArgs = [
